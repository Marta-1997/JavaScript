...
'El primer elemento que tiene la etiqueta h2: ' + y.innerHTML;
...
'El primer objeto que tiene la clase intro: ' + z[1].innerHTML;


//leemos el boton
const boton=document.querySelectorAll(".boton")
/*si ocurre el evento de click en el boton 0 sistituyo la bombilla por la imagen apagada*/
boton[0].addEventListener("click",()=>{
    const bombilla=document.querySelector("#bombilla");
        bombilla.src="img/off.gif";
    });
/*si ocurre el evento de click en el botn 1 sustituyo la bombilla por la imagen apagada*/
